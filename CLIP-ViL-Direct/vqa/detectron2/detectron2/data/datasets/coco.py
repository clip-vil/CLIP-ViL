...
def load_coco_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    ...
    print(image_root, json_file)
    if "2014" in image_root or "2015" in image_root:
        image_root = image_root.replace("coco", "coco_2014/images")
    if "2014" in json_file or "2015" in image_root:
        json_file = json_file.replace("coco", "coco_2014")
