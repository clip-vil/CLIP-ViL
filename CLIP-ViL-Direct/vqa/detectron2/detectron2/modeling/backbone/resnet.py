...
def build_resnet_backbone(cfg, input_shape):
    ...
    if "RN" in norm or "ViT" in norm:
        from .my_clip import CLIP
        clip = CLIP(norm, dc5=res5_dilation==2, out_features=out_features)
        # print(clip.output_shape())
        # exit()
        return CLIP(norm, dc5=res5_dilation==2, out_features=out_features)
    ...
    res = ResNet(stem, stages, out_features=out_features)
