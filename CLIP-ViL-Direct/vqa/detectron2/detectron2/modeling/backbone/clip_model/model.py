...
class ModifiedResNet(nn.Module):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64, dc5=False):
        super().__init__()
        ...
        if dc5:
            self.layer4 = self._make_layer(width * 8, layers[3], stride=1, dilation=2)
        else:
...
def build_model(state_dict: dict, dc5: bool):
